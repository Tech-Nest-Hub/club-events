...
> [!NOTE]
> - The download button will redirect to create a broadcom account. So, simply create a broadcom account or if you have one [sign in here](https://access.broadcom.com/default/ui/v1/signin/).
...
#### step - 4
Agree to the Terms & Conditions and click the download button. Then the download should start.
